...
function initSPD() {
  ...
  shareButton.addEventListener("click", async () => {
    ...
    const threadContainer = document.querySelectorAll(".each-response-cnt");
    ...
    for(let i=0; i<threadContainer.length; i++){
      const question = threadContainer[i].querySelector(".response-question h3");
      const answer = threadContainer[i].querySelector(".response-answer .inline-message-container")
