...
export default function Comment({
  ...
  return (
    <div
      ...
      } rounded-lg p-6 bg-secondary-1 text-white`}
    >
      ...
      {!fullComment && (
        <button
          ...
          className="mt-3 bg-accent text-white hover:bg-gray-50 text-center shadow-sm w-full text-sm h-8 rounded-md transition-all duration-75 focus:outline-none"
        >
          View Comment
        </button>
      )}
